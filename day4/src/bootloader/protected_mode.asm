...
_protected_mode_entry_asm:
    ...
    mov eax, TSS
    and eax, 0xffffff
    mov [GDT64 + GDT64_TSS + 2], ax
    shr eax, 16
    mov [GDT64 + GDT64_TSS + 4], al
...
GDT64_Code equ $ - GDT64
    dw 0                                        ; Limit (low, bits 0-15)
    dw 0                                        ; Base (low, bits 0-15)
    db 0                                        ; Base (mid, bits 16-23)
    db PRESENT | NOT_SYS | EXEC | RW            ; Access
    db LONG_MODE                                ; Flags & Limit (high, bits 16-19)
...
GDT64_Data equ $ - GDT64
    ...
    db SZ_32                                    ; Flags & Limit (high, bits 16-19)
    db 0                                        ; Base (high, bits 24-31)
global GDT64_TSS
GDT64_TSS equ $ - GDT64
    dw 0x68                                     ; Limit (low, bits 0-15)
    dw 0                                        ; Base (low, bits 0-15)
    db 0                                        ; Base (mid-low, bits 16-23)
    db PRESENT | SYS_TSS_AVL                    ; Access
    db GRANULARITY_4K                           ; Flags & Limit (high, bits 16-19)
